...
module.exports = [
  ...
  },
  {
    ...
    description:
      "La pera es el fruto del peral, árbol de la familia de las rosáceas. El fruto es un pomo comestible de verde marron. Es una especie de árbol caducifolio, generalmente de 2 hasta 20 m de altura.",
    bloom: "Otoño",
  ...
  },
  {
    ...
    origin: "Indomalaya",
    description:
      "Es un fruto comestible, botánicamente una baya, de varios tipos de grandes plantas herbáceas. A estas plantas de gran porte que tienen aspecto de arbolillo se las denomina plataneras, bananeros, bananeras, plátanos o bananos. Es un fruto con variables en tamaño (10 cm), color y firmeza, alargado, generalmente curvado y carnoso.",
    bloom: "",
  ...
  },
  {
    ...
    origin: "Asia",
    description:
      "Es un pequeño árbol frutal perenne. Su fruto es el limón. Una fruta comestible de sabor ácido y extremadamente fragante que se usa principalmente en la alimentación. Es un árbol que a menudo con espinas, puede alcanzar los 4 m de altura, con una copa muy ramificada.",
    bloom: "Otoño y Invierno",
    maturation_fruit: "",
    life_cycle: "50-100 años",
    climatic_zone: "Mediterráneo",
    created: "2022-07-16T00:00:00Z",
    producing_countries: [
      {
        country: "India",
      },
  ...
  },
  {
    ...
    origin: "Asia",
    description:
      "Es un fruto del árbol mandarino. Es el citrico más similar a la naranja, aunque de menor tamaño, sabor más aromático y con mayor facilidad para quitar su piel en la mayoria de sus variedades, así como una acidez ligeramente inferior y una mayor proporción de azúcares simples.",
    bloom: "Primavera",
    maturation_fruit: "",
    life_cycle: "100 años",
  ...
  },
  {
    ...
    origin: "Asia",
    description:
      "La naranja es una fruta cítrica obtenida del naranjo dulce. Es un hesperidio carnoso de cáscara más o menos gruesa y endurecida, y su pulpa está formada típicamente por once gajos u hollejos llenos de jugo",
    bloom: "Primavera",
  ...
  },
  {
    ...
    description:
      "La ciruela es una fruta de forma redondeada u oval con estructura acorazonada, atravesada por un surco que la recorre longitudinalmente dividiéndola prácticamente en dos. Su hueso es oblongo, con dos semillas en el interior que, transcurrido un mes, pierden su facultad germinativa.",
    bloom: "Otoño",
    maturation_fruit: "Invierno",
    life_cycle: "30 años",
    climatic_zone: "Templado",
    created: "2022-07-19T00:00:00Z",
    producing_countries: [
      {
        country: "Turquía",
      },
  ...
  },
  {
    ...
    origin: "India",
    description:
      "El árbol de mango es un árbol perenne siempreverde perteneciente al género Mangifera. Es un árbol frutal tropical originario del continente asiático. Aunque existen diversas especies comestibles de este género, la más conocida y popular en cultivos es Mangifera indica (mango).",
    bloom: "Invierno",
    maturation_fruit: "Primavera y Verano",
    life_cycle: "300 años",
    climatic_zone: "Tropical",
    created: "2022-07-24T00:00:00Z",
    producing_countries: [
      {
        country: "India",
      },
  ...
  },
  {
    ...
    description:
      "Es un árbol de gran volumen que puede alcanzar los 30 m de altura. Las hojas son simples, aovadas a oblongas, con el margen crenado o aserrado, ligeramente acuminadas, y miden entre 6 y 15 cm de longitud y 3 a 8 cm de ancho. ",
    bloom: "Invierno",
    maturation_fruit: "Primavera",
    life_cycle: "40",
    climatic_zone: "Templado",
    created: "2022-07-26T00:00:00Z",
    producing_countries: [
      {
        country: "Japón",
      },
  ...
  },
  {
    ...
    bloom: "Primavera",
    maturation_fruit: "Verano",
    life_cycle: "30-40 años",
    climatic_zone: "Tropical",
    created: "2022-07-27T00:00:00Z",
    producing_countries: [
      {
        country: "Mexico",
      },
  ...
  },
  {
    ...
    family: "Lauraceae",
    origin: "Mexico, Guatemala, y El Salvador",
    description:
      "En estado silvestre, el árbol puede alcanzar alturas de alrededor de 20 m, y un diámetro a la altura del pecho de 30-60 cm, con tronco erecto o torcido. Los árboles en plantación, generalmente derivados de injertos y sujetos a podas de formación, muestran una apariencia muy distinta. Copa: extendida, globulosa o acampanulada, con ramas bajas, ramas jóvenes al principio, de color verde amarillento, que después se tornan opacas y con cicatrices prominentes dejadas por las hojas. Corteza: áspera, a veces surcada longitudinalmente. El fruto es una baya oval o piriforme, según la variedad, de tamaño muy variado, cáscara de color verde a púrpura oscuro, pudiendo ser delgada, gruesa, lisa o ligeramente rugosa, a veces con una apariencia como la del cuero.",
    bloom: "Invierno",
    maturation_fruit: "Verano y Otoño",
    life_cycle: "200-400 años",
    climatic_zone: "Tropical",
    created: "2022-07-28T00:00:00Z",
    producing_countries: [
      {
        country: "Mexico",
      },
  ...
  },
  {
    ...
    family: "Oxalidaceae",
    origin: "Indonesia, Sri Lanka, y la India",
    description:
      "Su fruto (la carambola) se presenta en racimos en las ramas y en el tronco: bayas gruesas, ovoides o elipsoides, de color amarillo-anaranjado en la madurez, estrellados con 5 ángulos. Su corte transversal es el de una estrella de cinco puntas. Su pulpa es jugosa, un poco fibrosa y ácida.",
    bloom: "Perenne",
    maturation_fruit: "Perenne",
    life_cycle: "40 años",
    climatic_zone: "Tropical",
  ...
  },
  {
    ...
    origin: "Iran",
    description:
      "Es un árbol frutal que puede desarrollarse de forma arbustiva, caducifolio, más o menos espinoso y muy ramificado. Tronco recto, con la corteza resquebrajada y ramas opuestas, patentes; las jóvenes tetrágonas y a veces péndulas. Las hojas son entre lanceoladas y oblongas, opuestas o subopuestas –en ramas jóvenes– o bien reunidas en fascículos alternos o subopuestos, caducas, subcoriáceas, lustrosas por el haz, glabras, de un verde amarillento, atenuadas en corto pecíolo con un ápice obtuso, a menudo redondeado –por excepción emarginado–, con glándula terminal (nectario) poco evidente.",
    bloom: "Primavera y Verano",
    maturation_fruit: "Otoño e Invierno",
    life_cycle: "200 años",
    climatic_zone: "Tropical",
    created: "2022-07-29T00:00:00Z",
    producing_countries: [
  ...
  },
  {
    ...
    origin: "China",
    description:
      "El litchi es un árbol de hoja perenne de tamaño medio, que forma una densa copa redondeada. La fruta es una drupa ovoide, acorazonada o casi redonda. La parte exterior es de color rosa intenso a rojo, de textura lisa o rugosa con protuberancias; fina y fácil de retirar. El mesocarpio está formado por una pulpa jugosa blanca y translúcida, de sabor dulce y fragante. En el centro se encuentra la semilla rodeada por un duro endocarpio.",
    bloom: "Perenne",
    maturation_fruit: "Summer",
    life_cycle: "1000 años",
    climatic_zone: "Tropical",
    created: "2022-07-29T00:00:00Z",
    producing_countries: [
      {
  ...
  },
  {
    ...
    origin: "Asia",
    description:
      "Es un árbol originario del sudeste asiático. Su fruto, especialmente apreciado por los nativos, es de varias formas, de cuadrada a redonda, según la especie. Tiene un caparazón de espinas de color verde o café, su cáscara es entre pálida y roja, siempre según la especie.​ Tiene un gusto intenso y agradable, una textura cremosa y un olor muy fuerte, que puede disgustar a algunas personas; incluso se ha llegado a decir que es la fruta más apestosa del mundo.",
    bloom: "Perenne",
    maturation_fruit: "Verano",
    life_cycle: "80 a 150 años",
    climatic_zone: "Tropical",
    created: "2022-07-29T00:00:00Z",
    producing_countries: [
      {
  ...
  },
  {
    ...
    family: "Clusiaceae",
    origin: "Sudeste Asiatico",
    description:
      "El árbol de mangostán alcanza 6 a 25 m de altura y su tronco 9 a 12 cm de diámetro,​ su copa de forma cónica posee follaje muy denso siempre verde de hojas opuestas, grandes con nervadura central, de coloración verde oscura,​ con forma elíptica y el ápice acuminado y corto. El fruto comestible posee una corteza de tono púrpura rojizo oscuro cuando maduro. Su semilla es recalcitrante. Botánicamente un arilo, la fragante carne comestible es dulce y agria, con sabor cítrico y textura de durazno. Botánicamente, no tiene relación alguna con el mango.",
    bloom: "Perenne",
    maturation_fruit: "Verano",
    life_cycle: "100 años",
    climatic_zone: "Tropical",
